...
import logo from '../../public/hamza.webp'
    ...
    <footer className="footer">
        <div className="footer-container">
            <div className="footer-img">
                <Image src={logo} alt="not found" className='footerImg'/>
            </div>
            <div className="footer-links">
                <h2>Connection</h2>
                <a href="#services">Services</a>
                <a href="#skill">Portfolio</a>
        ...
        <div className="bottom-footer">
            <div className="bottom-footerleft">
                <p>Created By <span>H</span>amza Tahir | All Rights Reserved!</p>
            </div>

            <div className="bottom-footerright">
                <p>Follow me --- </p>
